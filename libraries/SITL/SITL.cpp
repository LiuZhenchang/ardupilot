...
const AP_Param::GroupInfo SITL::var_info[] = {
    ...
    AP_GROUPINFO("GYR_RND",    1, SITL,  gyro_noise,  0.5f),
    AP_GROUPINFO("ACC_RND",    2, SITL,  accel_noise, 0.5f),
    AP_GROUPINFO("MAG_RND",    3, SITL,  mag_noise,   0.5f),
    ...
    AP_GROUPINFO("WIND_DIR",  10, SITL,  wind_direction,  160),
    AP_GROUPINFO("WIND_TURB", 11, SITL,  wind_turbulance,  0.8),
    ...
    AP_GROUPINFO("ACC2_RND",      42, SITL,  accel2_noise, 0.1f),
    ...
    AP_GROUPINFO("GPS_NOISE",     58, SITL,  gps_noise, 0.8f),
